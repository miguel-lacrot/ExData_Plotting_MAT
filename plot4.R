...
plot(powerSub$Time, powerSub$Voltage, type = "l", ylab = "Voltage", xlab = "")
...
legend("topright", bty ="n", cex = 0.7, lty = c(1,1,1), 
       col = c("black", "red", "blue"), 
       legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
plot(powerSub$Time, powerSub$Global_reactive_power, type = "l", 
